...
const ThreeCityScene: React.FC<ThreeCitySceneProps> = ({ buildings, selectedBuildingId, camera, onBuildingSelect }) => {
  ...
  useEffect(() => {
    ...
    buildingList.forEach((building) => {
      ...
      const METERS_TO_SCENE_UNITS = 0.4;
      ...
      const floorCount = metrics.visualFloors;
      const baseHeight = floorCount * 5 * METERS_TO_SCENE_UNITS;
      const height = Math.max(3.2, Math.min(18, baseHeight));
